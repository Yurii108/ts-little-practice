...
type ICurrClients = Omit<IAllClients, "makeCallFor">;
type IExClients = Omit<IAllClients, "timeLeft">;
type IFutureClients = Pick<IAllClients, "name" | "makeCallFor">;
